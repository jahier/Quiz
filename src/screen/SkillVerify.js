...
const navigate=()=>{
    if(props.route.params.data==='1'){
        ...
        props.navigation.navigate('DuoMode')
    ...
    return (
        <SafeAreaView style={styles.mainContent}>
            ...
            <View style={{ paddingHorizontal: 15, justifyContent: 'flex-end', alignItems: 'center', padding: 15 }}>
                <TouchableOpacity onPress={() => handleBtn()} style={{ backgroundColor: '#172866', height: 50, width: '100%', borderRadius: 10, justifyContent: 'center', alignItems: 'center', flexDirection: 'row' }}>
